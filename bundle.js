...
/***/ function(module, exports, __webpack_require__) {
	...
	var Musics = __webpack_require__(226);
	var Detail = __webpack_require__(227);
	var Login = __webpack_require__(228);
	var Register = __webpack_require__(229);
		...
		render: function render() {
			return React.createElement(
				...
				React.createElement(
					...
					React.createElement(Route, { path: '/musics', component: Musics }),
							...
							React.createElement(
								...
								React.createElement(
									...
									React.createElement(
										...
										React.createElement('input', { type: 'text', className: 'form-control', placeholder: '\u5F20\u827A\u8C0B', ref: 'search_cont' }),
										React.createElement(
											'span',
											{ className: 'input-group-btn' },
											React.createElement(
												'button',
												{ className: 'btn btn-default', type: 'button', onClick: this.handlerSearch },
												'\u641C\u7D22'
											)
										)
									)
				...
				for (var i = 0; i < listLen; i++) {
					...
					lst.push(React.createElement(
						...
						React.createElement(
							...
							React.createElement(
								NavLink,
								{ to: detailUrl, className: 'btn btn-default', role: 'button' },
								'\u67E5\u770B\u8BE6\u60C5 \xBB'
							)
						)
					));
	...
	var Detail = React.createClass({
		...
		render: function render() {
			...
			$.each(this.state.list, function (i, ele) {
				if (ele.id == _id) {
					// console.log(ele);
					detail.push(React.createElement(
						'div',
						{ className: 'detail', key: _id },
						React.createElement(
							'h2',
							null,
							ele.title,
						...
						React.createElement(
							...
							React.createElement(
								'div',
								{ className: 'detail_l' },
								React.createElement('img', { src: ele.images.large })
							),
							React.createElement(
								'ul',
								{ className: 'detail_r' },
								...
								React.createElement(
									'li',
									{ className: 'casts' },
									'\u4E3B\u6F14: \u4F11\xB7\u6770\u514B\u66FC / \u5E15\u7279\u91CC\u514B\xB7\u65AF\u56FE\u5C14\u7279 / \u8FBE\u8299\u59AE\xB7\u57FA\u6069 / \u6CE2\u4F0A\u5FB7\xB7\u970D\u5E03\u9C81\u514B / \u65AF\u6234\u82AC\xB7\u83AB\u660C\u7279 / \u4F0A\u4E3D\u838E\u767D\xB7\u7F57\u5FB7\u91CC\u683C\u65AF / \u591A\u4E3D\u4E1D\xB7\u83AB\u5C14\u52A0\u591A / \u7406\u67E5\u5FB7\xB7E\xB7\u683C\u5170\u7279 / \u739B\u4E3D\xB7\u4F69\u987F\xB7\u65AF\u56FE\u5C14\u7279 / \u4F0A\u5229\u65AF\xB7\u5C3C\u5C14 / \u827E\u745E\u742A\xB7\u62C9\xB7\u585E\u62C9 / \u52B3\u4F26\xB7\u683C\u7F57\u65AF / \u80E1\u5B89\xB7\u8D3E\u65AF\u5E15 / \u514B\u65E5\u4EC0\u6258\u592B\xB7\u7D22\u4EC0\u65AF\u57FA / \u8428\u535A\xB7\u73ED\u514B\u68EE'
								),
								React.createElement(
									'li',
									null,
								...
								React.createElement(
									'li',
									null,
									'\u4E0A\u6620: 2017-02-17(\u67CF\u6797\u7535\u5F71\u8282), 2017-03-03(\u4E2D\u56FD\u5927\u9646/\u7F8E\u56FD)'
								)
							)
						),
						React.createElement(
							...
							React.createElement(
								...
								'2029\u5E74\uFF0C\u53D8\u79CD\u4EBA\u5927\u5E45\u51CF\u5C11\uFF0CX\u6218\u8B66\u5DF2\u7ECF\u89E3\u6563\u3002\u8EAB\u5FC3\u75B2\u60EB\u7684\u91D1\u521A\u72FC\u7F57\u6839\uFF08\u4F11\xB7\u6770\u514B\u66FC Hugh Jackman \u9970\uFF09\u81EA\u6108\u56E0\u5B50\u9010\u6E10\u6D88\u5931\uFF0C\u6574\u5929\u996E\u9152\u5EA6\u65E5\uFF0C\u9760\u5F53\u53F8\u673A\u517B\u5BB6\u3002\u4ED6\u5728\u58A8\u897F\u54E5\u8FB9\u5883\u9690\u5C45\uFF0C\u5E76\u7167\u987E\u7740\u9971\u53D7\u75C5\u75DB\u6298\u78E8\u7684\u8001X\u6559\u6388\uFF08\u5E15\u7279\u91CC\u514B\xB7\u65AF\u56FE\u5C14\u7279 Patrick Stewart \u9970\uFF09\u3002\u6709\u4E00\u5929\uFF0C\u4E00\u4F4D\u964C\u751F\u5973\u5B50\u8BA9\u7F57\u6839\u9001\u4E00\u4E2A\u53EB\u52B3\u62C9\uFF08\u8FBE\u8299\u59AE\xB7\u91D1 Dafne Keen \u9970\uFF09\u7684\u5973\u5B69\u53BB\u52A0\u62FF\u5927\u8FB9\u5883\uFF0C\u4E00\u5F00\u59CB\u7F57\u6839\u62D2\u7EDD\u4E86\uFF0C\u4F46\u67E5\u5C14\u65AF\u4E00\u76F4\u5728\u7B49\u7740\u8FD9\u4E2A\u5973\u5B69\u7684\u51FA\u73B0\uFF0C\u52B3\u62C9\u62E5\u6709\u8D85\u5F3A\u7684\u6218\u6597\u529B\uFF0C\u800C\u4E14\u5728\u8BB8\u591A\u65B9\u9762\u90FD\u5F88\u50CF\u91D1\u521A\u72FC\u3002\u5979\u88AB\u4E00\u4E2A\u5F3A\u5927\u516C\u53F8\u7684\u5E55\u540E\u4EBA\u7269\u6240\u8FFD\u8E2A\uFF0C\u56E0\u4E3A\u5979\u7684DNA\u91CC\u6709\u8FDE\u63A5\u7F57\u6839\u7684\u79D8\u5BC6\uFF0C\u4E00\u573A\u65E0\u4F11\u6B62\u7684\u8FFD\u6355\u7531\u6B64\u5C55\u5F00\u3002'
							)
						),
						React.createElement(
							'div',
		...
		render: function render() {
			return React.createElement(
				...
				React.createElement(
					...
					React.createElement(
						'h2',
						{ className: 'form-signin-heading text_c' },
						'\u7528\u6237\u767B\u5F55'
					),
					React.createElement(
						'label',
					...
					React.createElement('input', { type: 'email', id: 'inputEmail', className: 'form-control', placeholder: '\u90AE\u7BB1\u53F7\u6216\u7528\u6237\u540D', required: true, autofocus: true, ref: 'username' }),
					React.createElement(
						'label',
						{ 'for': 'inputPassword', className: 'sr-only' },
						'\u5BC6\u7801'
					),
					React.createElement('input', { type: 'password', id: 'inputPassword', className: 'form-control', placeholder: '\u5BC6\u7801', required: true, ref: 'password' }),
					React.createElement(
						'div',
						{ className: 'checkbox' },
						React.createElement(
					...
					React.createElement(
						'button',
						{ className: 'btn btn-lg btn-primary btn-block', type: 'submit', onClick: this.handlerSubmit },
						'\u767B\u5F55'
					)
				)
			);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Register = React.createClass({
		...
		handlerRegist: function handlerRegist(e) {
			e.preventDefault();
		...
		render: function render() {
			return React.createElement(
				...
				React.createElement(
					...
					React.createElement('input', { type: 'email', id: 'inputEmail', className: 'form-control', placeholder: '\u90AE\u7BB1\u53F7\u6216\u624B\u673A\u53F7', required: true, autofocus: true, ref: 'username' }),
					React.createElement(
						'label',
						{ 'for': 'inputPassword', className: 'sr-only' },
						'\u5BC6\u7801'
					),
					React.createElement('input', { type: 'password', id: 'inputPassword', className: 'form-control', placeholder: '\u8BBE\u7F6E\u5BC6\u7801', required: true, ref: 'password' }),
					React.createElement(
						'button',
						{ className: 'btn btn-lg btn-primary btn-block', type: 'submit', onClick: this.handlerRegist },
						'\u6CE8\u518C'
					)
				)
			);
		...
		render: function render() {
			...
			if (len > 0) {
				for (var i = 0; i < len; i++) {
					...
					ls.push(React.createElement(
						'div',
						{ className: 'col-lg-3 list', key: i * 100 },
						React.createElement('img', {
